...
const AboutUs = () => {
  return (
    <div className="min-h-screen bg-zinc-950 text-white px-6 py-12">
      ...
      {/* Mission Section */}
      <section className="bg-zinc-900 border border-indigo-700 rounded-xl p-8 mb-10 shadow-lg max-w-5xl mx-auto">
        <div className="flex items-center gap-4 mb-4">
          <HeartHandshake className="text-indigo-400" size={28} />
      ...
      <section className="max-w-5xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
          {[
            ...
            { name: "Riya Das", role: "UI/UX Designer" },
            { name: "Amit Sen", role: "Backend Engineer" },
          ].map((member, idx) => (
            <div
              key={idx}
              className="bg-zinc-800 p-5 rounded-xl text-center border border-zinc-700 hover:border-indigo-500 transition"
            >
              <div className="w-20 h-20 mx-auto rounded-full bg-zinc-700 flex items-center justify-center text-indigo-400 text-xl font-semibold mb-4">
      ...
      {/* Quality Section */}
      <section className="bg-zinc-900 border border-indigo-700 rounded-xl p-8 mt-12 shadow-lg max-w-5xl mx-auto">
        <div className="flex items-center gap-4 mb-4">
